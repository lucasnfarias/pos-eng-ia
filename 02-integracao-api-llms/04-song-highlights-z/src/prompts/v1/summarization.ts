...
export const SummarySchema = z.object({
  ...
  favoriteGenres: z
    .array(z.string())
    .optional()
    .describe("Gêneros musicais favoritos mencionados"),
  favoriteBands: z
    .array(z.string())
    .optional()
    .describe("Bandas ou artistas favoritos mencionados"),
  keyPreferences: z
    .string()
    .describe(
      "Sumário conciso das preferências musicais, padrões de humor e hábitos",
    ),
  importantContext: z
    .string()
    .optional()
    .describe("Qualquer outro contexto importante sobre o usuário"),
});
...
export const getSummarizationSystemPrompt = () => {
  return JSON.stringify({
    ...
    campos_para_extrair: {
      ...
      keyPreferences:
        "Sumário de 2-4 frases sobre gostos, padrões de humor e contexto de escuta",
