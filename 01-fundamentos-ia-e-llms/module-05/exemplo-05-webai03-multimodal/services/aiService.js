    ...
    async checkRequirements() {
        ...
        if (availability === 'downloadable') {
            ...
            try {
                ...
                console.log(`Try calling await LanguageModel.create({}) directly on Chrome Debugger console`)
    ...
    async* createSession(question, temperature, topK, file = null) {
        ...
        this.session = await LanguageModel.create({
            expectedInputs: [
                ...
                // { type: "audio" }, for some reason audio gives Error: Capability not available
                { type: "image" },
            ],
